...
read N
case $N in
  1) echo "Password: Pwd@CentOS" ; read -s -n1 -p "Press any key to continue..." ;bash DebianNET.sh -dd "$(echo "1_YyQ4Vvq7e4U8nA0VMdakpJBnxf0ol2W" |xargs -n1 bash <(wget --no-check-certificate -qO- 'https://raw.githubusercontent.com/ouyangmland/gdlink.sh/master/gdlink.sh'))";;
