...
function Start() {
  ...
  read N
  case $N in
    1) echo -e "\nPassword: Pwd@CentOS\n"; read -s -n1 -p "Press any key to continue..." ; bash /tmp/InstallNET.sh -dd 'https://speeds.oss-cn-hongkong-internal.aliyuncs.com/centos-7-image' $DMIRROR ;;
    2) echo -e "\nPassword: Pwd@CentOS\n"; read -s -n1 -p "Press any key to continue..." ; bash /tmp/InstallNET.sh -dd 'https://speeds.oss-cn-hongkong-internal.aliyuncs.com/centos-76-image' $DMIRROR ;;
